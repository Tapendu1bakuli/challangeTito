...
class VotingVideoPlayback extends StatefulWidget {
  VotingVideoPlayback({Key? key, this.videoPath, this.beatname})
      : super(key: key);
  ...
  @override
  _VotingVideoPlaybackState createState() => _VotingVideoPlaybackState();
}

class _VotingVideoPlaybackState extends State<VotingVideoPlayback> {
