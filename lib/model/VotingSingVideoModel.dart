class VotingSingingVideoModel {
  VotingSingingVideoModel({
    this.status = "",
    this.message = "",
  ...
  VotingSingingVideoModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class VotingVideoList {
  VotingVideoList(
      ...
      this.savedVideoLocation, required this.tos,
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['saved_thumb'] = savedVideoLocation;
    _data['tos'] = tos;
    return _data;
  }
}
